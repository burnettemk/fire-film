  ...
  certifications: {
    AU: [
      ...
      },
      {
        certification: "MA 15+",
        meaning:
          "Not suitable for children and teens under 15; MA15+-rated programming may only be broadcast between 9:00 p.m. and 5:00 a.m. on any given day. Consumer advice is mandatory. Some R18+ rated movies on DVD/Blu-ray are often re-edited on free TV/cable channels to secure a more ",
        order: 6,
      },
      {
        certification: "AV 15+",
        meaning:
          "Not suitable for children and teens under 15; this is the same as the MA15+ rating, except the ",
        order: 7,
      },
      {
        certification: "R 18+",
    ...
    CA: [
      ...
      },
      {
        certification: "C8",
        meaning:
          "Suitable for children ages 8+. Low level violence and fantasy horror is allowed. No foul language is allowed, but occasional ",
        order: 3,
      },
      {
        certification: "G",
    ...
    KR: [
      ...
      },
      {
        certification: "7",
        meaning:
          "This rating is for programming that may contain material inappropriate for children younger than 7, and parental discretion should be used. Some cartoon programming not deemed strictly as ",
        order: 3,
      },
      {
        certification: "12",
    ...
    FI: [
      ...
      },
      {
        certification: "K7",
        meaning:
          "Not allowed air before 7:00 a.m., not recommended for children under 7.",
        order: 1,
      },
      {
        certification: "K12",
        meaning:
          "Not allowed air before 5:00 p.m., not recommended for children under 12.",
        order: 2,
      },
      {
        certification: "K16",
        meaning:
          "Not allowed air before 9:00 p.m., not recommended for children under 16.",
        order: 3,
      },
      {
        certification: "K18",
        meaning:
          "Not allowed air before 11:00 p.m., not recommended for children under 18.",
        order: 4,
      },
    ],
    MY: [
      ...
      },
      {
        certification: "P13",
        meaning:
          "Viewers under 13 years of age need parental/guardian supervision while viewing. Can be broadcast anytime, but some elements may only be broadcast at night.",
        order: 2,
      },
      {
        certification: "18",
        meaning:
          "For viewers 18 and above. Cannot be broadcast before 10:00 PM.",
        order: 3,
      },
    ],
    NZ: [
    ...
    BG: [
      ...
      },
      {
        certification: "18",
        meaning:
          "Content suitable for viewers over the age of 18. Not allowed before 23:00.",
        order: 5,
      },
    ],
    MX: [
      ...
      },
      {
        certification: "B",
        meaning:
          "Designed for ages 12 and older (allowed only between 16:00 and 05:59).",
        order: 3,
      },
      {
        certification: "B-15",
        meaning:
          "Designed for ages 15 and up (allowed only between 19:00 and 05:59).",
        order: 4,
      },
      {
        certification: "C",
    ...
    ID: [
      ...
      },
      {
        certification: "D",
        meaning:
          "Suitable for viewers over 18 and older. Programmes with this rating are aired from 10.00 PM to 03.00 AM.",
        order: 5,
      },
    ],
    TR: [
    ...
    PL: [
      ...
      },
      {
        certification: "7",
        meaning:
          "As above; may additionally contain some mild language, bloodless violence, and a more negative view of the world.",
        order: 2,
      },
      {
        certification: "12",
        meaning:
          "May contain some foul language, some violence, and some sexual content.",
        order: 3,
      },
      {
        certification: "16",
    ...
    IL: [
      ...
      },
      {
        certification: "G",
        meaning:
          "General Audiences. Anyone, regardless of age, can watch the programme.",
        order: 1,
      },
      {
        certification: "12+",
    ...
    TW: [
      ...
      },
      {
        certification: "6+",
        meaning:
          "Not suitable for viewing by children under the age of six; children over six and under the age of twelve can view if accompanied by parents, teacher or an adult relative.",
        order: 2,
      },
      {
        certification: "12+",
        meaning:
          "Not suitable for viewing by children under the age of twelve, split from the former rating Parental Guidance.",
        order: 3,
      },
      {
        certification: "15+",
        meaning:
          "Not suitable for viewing by people under the age of fifteen, split from the former rating Parental Guidance.",
        order: 4,
      },
      {
        certification: "18+",
        meaning:
          "Not suitable for viewing by people under the age of eighteen.",
        order: 4,
      },
    ],
    ZA: [
      ...
      },
      {
        certification: "PG",
        meaning:
          "Children under 6 may watch this programme/film, but must be accompanied by an adult. This program contains an adult related theme, which might include very mild language, violence and sexual innuendo. A logo must be displayed in the corner of the screen for one minute after each commercial break.",
        order: 2,
      },
      {
        certification: "13",
        meaning:
          "Children under 13 are prohibited from watching this programme/film. This programme contains mild language, violence and sexual innuendo. A logo must be displayed in the corner of the screen for two minutes after each commercial break.",
        order: 3,
      },
      {
        certification: "16",
